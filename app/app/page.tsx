...
const INTEL_STEPS = [
  ...
  },
  {
    ...
    sym: '◈',
    title: 'Analyze',
    body: 'The ARVI agent reads all sensor streams through Bankr and cross-references with NASA satellite data. It detects invisible threats: a slow drought forming, early-stage tree plague, an air quality anomaly 3km from the nearest weather station. OpenServ coordinates parallel agent responses.',
    tag: 'BANKR · OPENSERV',
    tagColor: '#5e72e4',
