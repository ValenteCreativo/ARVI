...
export const metadata: Metadata = {
  ...
  keywords: ['ARVI', 'urban forest', 'environmental monitoring', 'AI agent', 'blockchain', 'Base', 'autonomous'],
  openGraph: {
    title: 'ARVI — Autonomous Urban Forest Intelligence',
    description: 'AI agent that monitors urban forests, detects threats in real time, and triggers autonomous responses.',
    type: 'website',
  },
}
